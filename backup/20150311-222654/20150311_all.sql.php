...
INSERT INTO rg_category VALUES('24','5','article','1','1','1','For iPhone 6 plus Parts','For-iPhone-6-plus-Parts','','','list','','','1')
...
CREATE TABLE `rg_total_visitor` (  `id` int(10) NOT NULL AUTO_INCREMENT,  `time` int(10) DEFAULT NULL,  `count` int(10) DEFAULT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='访客统计';
...
INSERT INTO rg_total_visitor VALUES('12','1425916800','243')
INSERT INTO rg_total_visitor VALUES('13','1426003200','35')
