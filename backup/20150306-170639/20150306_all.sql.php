...
CREATE TABLE `rg_content` (  `content_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '文章ID',  `class_id` int(10) DEFAULT NULL COMMENT '栏目ID',  `title` varchar(250) DEFAULT NULL COMMENT '标题',  `urltitle` varchar(250) DEFAULT NULL COMMENT 'URL路径',  `font_color` varchar(250) DEFAULT NULL COMMENT '颜色',  `font_bold` tinyint(1) DEFAULT NULL COMMENT '加粗',  `font_em` tinyint(1) DEFAULT NULL,  `position` varchar(250) DEFAULT NULL,  `keywords` varchar(250) DEFAULT NULL COMMENT '关键词',  `description` varchar(250) DEFAULT NULL COMMENT '描述',  `time` int(10) DEFAULT NULL COMMENT '更新时间',  `image` varchar(250) DEFAULT NULL COMMENT '封面图',  `url` varchar(250) DEFAULT NULL COMMENT '跳转',  `sequence` int(10) DEFAULT NULL COMMENT '排序',  `status` int(10) DEFAULT NULL COMMENT '状态',  `copyfrom` varchar(250) DEFAULT NULL COMMENT '来源',  `views` int(10) DEFAULT '0' COMMENT '浏览数',  `taglink` int(10) DEFAULT '0' COMMENT 'TAG链接',  `tpl` varchar(250) DEFAULT NULL,  `site` int(10) DEFAULT '1',  PRIMARY KEY (`content_id`),  UNIQUE KEY `urltitle` (`urltitle`) USING BTREE,  KEY `title` (`title`) USING BTREE,  KEY `description` (`description`) USING BTREE,  KEY `keywords` (`keywords`),  KEY `class_id` (`class_id`) USING BTREE,  KEY `time` (`time`) USING BTREE) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='内容基础';
INSERT INTO rg_content VALUES('1','5','Slide 1 pro','Slide-1-pro','0','0','0','1,2','','','1425371820','/upload/2015-03-06/0e4f015bea6148b6cde4ab88c6bc5f55.jpg','','0','1','本站','1','1','','1')
INSERT INTO rg_content VALUES('2','5','Slide 2 pro','Slide-2-pro','0','0','0','2','','','1425372120','/upload/2015-03-06/bf343c36fc9da67b661cc6d9aae14cf3.jpg','','0','1','本站','5','1','','1')
INSERT INTO rg_content VALUES('3','5','Slide 3 pro','Slide-3-pro','0','0','0','2','','','1425372240','/upload/2015-03-06/0f1c5218d3fb4e50731c984b5a974998.jpg','','0','1','本站','7','1','','1')
INSERT INTO rg_content VALUES('4','5','Slide 4 pro','Slide-4-pro','0','0','0','2','','Slide 4 pro','1425620040','/upload/2015-03-06/f03fe7f1692473f0e9f0d367690bdef5.jpg','','0','1','本站','0','1','','1')
...
INSERT INTO rg_total_visitor VALUES('8','1425571200','222')
