...
CREATE TABLE `rg_category` (  `class_id` int(10) NOT NULL AUTO_INCREMENT,  `parent_id` int(10) DEFAULT '0',  `app` varchar(20) DEFAULT NULL,  `show` tinyint(1) unsigned DEFAULT '1',  `sequence` int(10) DEFAULT '0',  `type` int(10) NOT NULL DEFAULT '1',  `name` varchar(250) DEFAULT NULL,  `urlname` varchar(250) DEFAULT NULL,  `subname` varchar(250) DEFAULT NULL,  `image` varchar(250) DEFAULT NULL,  `class_tpl` varchar(250) DEFAULT NULL,  `keywords` varchar(250) DEFAULT NULL,  `description` varchar(250) DEFAULT NULL,  `upload_config` int(10) DEFAULT '1',  PRIMARY KEY (`class_id`),  UNIQUE KEY `urlname` (`urlname`) USING BTREE,  KEY `pid` (`parent_id`),  KEY `mid` (`app`),  KEY `sequence` (`sequence`)) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='栏目基础信息';
INSERT INTO rg_category VALUES('1','0','article','1','1','0','products','products','','','list','','','1')
INSERT INTO rg_category VALUES('2','0','article','1','2','0','News','News','','','list','','','1')
INSERT INTO rg_category VALUES('5','26','article','1','1','1','For iPhone Parts','For-iPhone-Parts','','/upload/2015-03-06/b90c5a8bb400d3d6540484b21b273d47.jpg','list','','','1')
INSERT INTO rg_category VALUES('6','27','article','1','2','1','For iPad Parts','For-iPad-Parts','','/upload/2015-03-06/bcb5464e43bc5bd4568259e27cedef49.jpg','list','','','1')
INSERT INTO rg_category VALUES('7','1','article','1','3','0','For Blackberry','For-Sumsung-Parts','','/upload/2015-03-06/0a078720cd860a45661c33414d459091.jpg','list','','','1')
INSERT INTO rg_category VALUES('8','26','article','1','4','1','For iPhone LCD Assembly','For-iPhone-LCD-Assembly','','','list','','','1')
...
INSERT INTO rg_category VALUES('24','26','article','1','3','1','For iPhone Parts submenu','For-iPhone-Parts-submenu','','','list','','','1')
INSERT INTO rg_category VALUES('25','26','article','1','2','1','For iPhone Parts submenu 2','For-iPhone-Parts-submenu-2','','','list','','','1')
INSERT INTO rg_category VALUES('26','1','article','1','1','0','For iPhone','For-iPhone','','','list','','','1')
INSERT INTO rg_category VALUES('27','1','article','1','2','0','For iPad','For-iPad','','','list','','','1')
INSERT INTO rg_category VALUES('28','1','article','1','3','1','For Sumsung','For-Sumsung','','','list','','','1')
...
INSERT INTO rg_category_article VALUES('5','2','content','','time DESC','10')
...
INSERT INTO rg_category_article VALUES('24','0','content','','time DESC','10')
INSERT INTO rg_category_article VALUES('25','0','content','','time DESC','10')
INSERT INTO rg_category_article VALUES('26','0','content','','time DESC','10')
INSERT INTO rg_category_article VALUES('27','0','content','','time DESC','10')
INSERT INTO rg_category_article VALUES('28','0','content','','time DESC','10')
...
INSERT INTO rg_config VALUES('site_url','ruigui-electronic.com')
...
INSERT INTO rg_config VALUES('mobile_status','1')
INSERT INTO rg_config VALUES('mobile_tpl','mobile')
INSERT INTO rg_config VALUES('mobile_domain','m.ruigui-electronic.com')
...
CREATE TABLE `rg_content` (  `content_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '文章ID',  `class_id` int(10) DEFAULT NULL COMMENT '栏目ID',  `title` varchar(250) DEFAULT NULL COMMENT '标题',  `urltitle` varchar(250) DEFAULT NULL COMMENT 'URL路径',  `font_color` varchar(250) DEFAULT NULL COMMENT '颜色',  `font_bold` tinyint(1) DEFAULT NULL COMMENT '加粗',  `font_em` tinyint(1) DEFAULT NULL,  `position` varchar(250) DEFAULT NULL,  `keywords` varchar(250) DEFAULT NULL COMMENT '关键词',  `description` varchar(250) DEFAULT NULL COMMENT '描述',  `time` int(10) DEFAULT NULL COMMENT '更新时间',  `image` varchar(250) DEFAULT NULL COMMENT '封面图',  `url` varchar(250) DEFAULT NULL COMMENT '跳转',  `sequence` int(10) DEFAULT NULL COMMENT '排序',  `status` int(10) DEFAULT NULL COMMENT '状态',  `copyfrom` varchar(250) DEFAULT NULL COMMENT '来源',  `views` int(10) DEFAULT '0' COMMENT '浏览数',  `taglink` int(10) DEFAULT '0' COMMENT 'TAG链接',  `tpl` varchar(250) DEFAULT NULL,  `site` int(10) DEFAULT '1',  PRIMARY KEY (`content_id`),  UNIQUE KEY `urltitle` (`urltitle`) USING BTREE,  KEY `title` (`title`) USING BTREE,  KEY `description` (`description`) USING BTREE,  KEY `keywords` (`keywords`),  KEY `class_id` (`class_id`) USING BTREE,  KEY `time` (`time`) USING BTREE) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='内容基础';
INSERT INTO rg_content VALUES('1','5','showcase1','showcase1','0','0','0','1,2','','$10-100','1425371820','/upload/2015-03-06/0e4f015bea6148b6cde4ab88c6bc5f55.jpg','','0','1','本站','7','1','','1')
INSERT INTO rg_content VALUES('2','5','showcase2','showcase2','0','0','0','2','Sumsung,LCD','$10-100','1425372120','/upload/2015-03-06/bf343c36fc9da67b661cc6d9aae14cf3.jpg','','0','1','本站','6','1','','1')
INSERT INTO rg_content VALUES('3','5','showcase3','showcase3','0','0','0','2','Blackberry,iPad,Housing','$11-50','1425372240','/upload/2015-03-06/0f1c5218d3fb4e50731c984b5a974998.jpg','','0','1','本站','7','1','','1')
INSERT INTO rg_content VALUES('4','5','showcase4','showcase4','0','0','0','2','iPhone,Parts','showcase4iPhone Parts','1425620040','/upload/2015-03-06/f03fe7f1692473f0e9f0d367690bdef5.jpg','','0','1','本站','24','1','','1')
...
INSERT INTO rg_content VALUES('12','6','Showcase5','Showcase452515354','0','0','0','2','iPhone','iPhone Parts','1426037340','/upload/2015-03-11/0e4f015bea6148b6cde4ab88c6bc5f55.jpg','','0','1','本站','0','1','','1')
INSERT INTO rg_content VALUES('14','7','Showcase6','Showcase6','0','0','0','2','','iPhone Parts','1426037460','/upload/2015-03-11/0f1c5218d3fb4e50731c984b5a974998.jpg','','0','1','本站','2','1','','1')
INSERT INTO rg_content VALUES('15','8','Showcase7','Showcase7','0','0','0','2','','iPhone Parts','1426037460','/upload/2015-03-11/bf343c36fc9da67b661cc6d9aae14cf3.jpg','','0','1','本站','2','1','','1')
INSERT INTO rg_content VALUES('16','6','Showcase8','Showcase8','0','0','0','2','','iPhone Parts','1426037520','/upload/2015-03-11/f03fe7f1692473f0e9f0d367690bdef5.jpg','','0','1','本站','4','1','','1')
...
INSERT INTO rg_content_article VALUES('12','&lt;span style=&quot;white-space:normal;&quot;&gt;iPhone Parts&lt;/span&gt;')
INSERT INTO rg_content_article VALUES('14','&lt;span style=&quot;white-space:normal;&quot;&gt;iPhone Parts&lt;/span&gt;')
INSERT INTO rg_content_article VALUES('15','&lt;span style=&quot;white-space:normal;&quot;&gt;iPhone Parts&lt;/span&gt;')
INSERT INTO rg_content_article VALUES('16','&lt;span style=&quot;white-space:normal;&quot;&gt;iPhone Parts&lt;/span&gt;')
...
DROP TABLE IF EXISTS rg_ext_price
CREATE TABLE `rg_ext_price` (  `data_id` int(10) DEFAULT NULL,  `price` varchar(250) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO rg_ext_price VALUES('1','$10-20')
...
INSERT INTO rg_field VALUES('5','2','价格','price','1','','regex','','','1','','0','','')
...
INSERT INTO rg_field_expand VALUES('5','')
...
CREATE TABLE `rg_fieldset` (  `fieldset_id` int(10) NOT NULL AUTO_INCREMENT,  `table` varchar(250) DEFAULT NULL,  `name` varchar(250) DEFAULT NULL,  PRIMARY KEY (`fieldset_id`),  UNIQUE KEY `table` (`table`)) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='字段集基础';
INSERT INTO rg_fieldset VALUES('1','guestbook','留言板')
INSERT INTO rg_fieldset VALUES('2','price','价格')
...
INSERT INTO rg_fieldset_expand VALUES('2','1')
...
INSERT INTO rg_file VALUES('18','/upload/2015-03-11/0e4f015bea6148b6cde4ab88c6bc5f55.jpg','/upload/2015-03-11/0e4f015bea6148b6cde4ab88c6bc5f55.jpg','0e4f015bea6148b6cde4ab88c6bc5f55','jpg','9412','1426037432')
INSERT INTO rg_file VALUES('19','/upload/2015-03-11/0f1c5218d3fb4e50731c984b5a974998.jpg','/upload/2015-03-11/0f1c5218d3fb4e50731c984b5a974998.jpg','0f1c5218d3fb4e50731c984b5a974998','jpg','12987','1426037477')
INSERT INTO rg_file VALUES('20','/upload/2015-03-11/b90c5a8bb400d3d6540484b21b273d47.jpg','/upload/2015-03-11/b90c5a8bb400d3d6540484b21b273d47.jpg','b90c5a8bb400d3d6540484b21b273d47','jpg','60387','1426037522')
INSERT INTO rg_file VALUES('21','/upload/2015-03-11/bcb5464e43bc5bd4568259e27cedef49.jpg','/upload/2015-03-11/bcb5464e43bc5bd4568259e27cedef49.jpg','bcb5464e43bc5bd4568259e27cedef49','jpg','52453','1426037545')
INSERT INTO rg_file VALUES('22','/upload/2015-03-11/f03fe7f1692473f0e9f0d367690bdef5.jpg','/upload/2015-03-11/f03fe7f1692473f0e9f0d367690bdef5.jpg','f03fe7f1692473f0e9f0d367690bdef5','jpg','11599','1426037560')
INSERT INTO rg_file VALUES('23','/upload/2015-03-11/bf343c36fc9da67b661cc6d9aae14cf3.jpg','/upload/2015-03-11/bf343c36fc9da67b661cc6d9aae14cf3.jpg','bf343c36fc9da67b661cc6d9aae14cf3','jpg','8939','1426038161')
...
INSERT INTO rg_tags VALUES('1','iPhone','1','4')
INSERT INTO rg_tags VALUES('2','Parts','1','1')
INSERT INTO rg_tags VALUES('3','Sumsung','1','3')
INSERT INTO rg_tags VALUES('4','LCD','1','3')
INSERT INTO rg_tags VALUES('5','Blackberry','2','2')
INSERT INTO rg_tags VALUES('6','iPad','2','2')
INSERT INTO rg_tags VALUES('7','Housing','8','2')
...
CREATE TABLE `rg_total_visitor` (  `id` int(10) NOT NULL AUTO_INCREMENT,  `time` int(10) DEFAULT NULL,  `count` int(10) DEFAULT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='访客统计';
...
INSERT INTO rg_total_visitor VALUES('13','1426003200','92')
INSERT INTO rg_total_visitor VALUES('14','1426089600','673')
INSERT INTO rg_total_visitor VALUES('15','1426176000','143')
INSERT INTO rg_total_visitor VALUES('16','1426780800','80')
