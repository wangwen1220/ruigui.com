<?php exit;?>001457799494ce6e6fb64f84032a32e554b5b62ee826s:3366:"a:2:{s:8:"template";s:3302:"<?php $__Template->display("themes/ruigui/header"); ?>
...
<main id="main" class="g-wrap">
  ...
  <div id="showcase" class="g-box">
    <ul class="f-tj">
      <?php $listList = service("duxcms","Label","contentList",array( "app"=>"DuxCms", "label"=>"contentList", "limit"=>"16", "pos_id"=>"2", "expand_id"=>"1"));  if(is_array($listList)) foreach($listList as $list){ ?>
      <li>
