<?php exit;?>0014567947963fca370ca3bb8b9bed1b991ee1f3e303s:3878:"a:2:{s:8:"template";s:3814:"<?php $__Template->display("themes/ruigui/header"); ?>
  ...
  <div class="g-mn">
    ...
    <div id="m-sld" class="m-sld s-box">
      ...
      <div class="bd">
        <ul>
          <?php $listList = service("duxcms","Label","contentList",array( "app"=>"DuxCms", "label"=>"contentList", "limit"=>5, "image"=>true));  if(is_array($listList)) foreach($listList as $list){ ?>
          <li><a href="<?php echo $list["aurl"];?>"><img src="<?php echo cut_image($list["image"],270,270);?>" width="270" height="270"></a></li>
          <?php } ?>
        </ul>
      </div>
    </div>
...
";s:12:"compile_time";i:1425258796;}";